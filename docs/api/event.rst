...
.. autoclass:: Trigger
   ...
   .. automethod:: __init__(event: typing.Type[Event] | str, *args: typing.Type[Event] | str, characters: collections.abc.Iterable[auraxium.ps2.Character | int] | None = None, worlds: collections.abc.Iterable[auraxium.ps2.World | int] | None = None, conditions: list[typing.Callable[[Event], bool]] | None = None, action: Callable[[Event], typing.Coroutine[None] | None] | None = None, name: str | None = None, single_shot: bool = False) -> None
