...
class Proxy(Generic[_Ps2ObjectT]):
    ...
    def _resolve_nested_payload(self, payload: CensusData) -> list[CensusData]:
        ...
        def resolve_join(join: JoinedQuery,
...
class SequenceProxy(Proxy[_Ps2ObjectT], abc.Awaitable[list[_Ps2ObjectT]]):
    ...
    def __await__(self) -> abc.Generator[Any, None, list[_Ps2ObjectT]]:
...
class InstanceProxy(Proxy[_Ps2ObjectT]):
    ...
    def __await__(self) -> abc.Generator[Any, None, _Ps2ObjectT | None]:
